...
//
// ISR code from: https://quadmeup.com/generate-ppm-signal-with-
// arduino/


//------------------------CHANNEL MAPPING------------------------
// 0: Throttle 1000 ppm is off, 2000 is full thrust
// 1: Ailerons 1500 ppm is neutral, 1000 is full right roll, 2000
//   is full left roll
// 2: Elevator 1500 ppm is neutral, 1000 is full down, 2000 is 
//   full up
// 3: Rudder   1500 ppm is neutral, 1000 is yaw right, 2000 is 
//   yaw left
// 4: N/A
...
#define PPM_FrLen 22500  //set the PPM frame length in 
//  microseconds (1ms = 1000µs)
